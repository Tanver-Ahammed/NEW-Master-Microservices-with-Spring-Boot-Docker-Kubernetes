...
import com.mss.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in M-Bank",
        description = "CRUD REST APIs in M-Bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside M-Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<ResponseDto> deleteAccountDetails(@Valid
                                                            @Pattern(regexp = "(^$|[0-9]{11})", message = "Mobile number must be 11 digits")
    ...
    public ResponseEntity<String> getBuildInfo() {
        LOGGER.debug("Invoking GET /build-info");
